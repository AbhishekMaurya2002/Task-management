                    ...
                    <form className="w-full mt-12 sm:mt-0 max-w-lg" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-wrap -mx-3 mb-2 sm:mb-6">
                            <div className="w-full px-3">
                                ...
                                <textarea
                                    className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 min-h-[120px]"
                                    id="description"
                        ...
                        <button 
                            type='submit' 
                            className='mt-8 w-full p-3 bg-green-600 rounded-lg text-center text-white hover:bg-green-500'
                        >
                            Add
                        </button>
                    </form>
